...
import { SIDEBAR_ITEMS, SIDEBAR_LINKS } from "@/constants/links";
import { Book, LogOutIcon, NewspaperIcon, SearchIcon } from "lucide-react";
                        ...
                        return (
                            <li key={index} className="w-full flex">
                                <Container delay={0.1 + index / 10}>
                                    ...
                                    >
                                        <DocumentIcon className="size-[16px] mr-1.5" />
                                        {link.label}
                                    </Link>
                                </Container>
                            </li>
