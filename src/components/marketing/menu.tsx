                                ...
                                <NavigationMenuLink asChild>
                                    ...
                                    >
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Chat with our Ai and find out more about yourself
                                        </p>
                                    </Link>
                                </NavigationMenuLink>
                            </li>
                            <Item title="Тооцоолуур" href="/features/content-calendar" icon={<CalendarRangeIcon className="w-5 h-5" />}>
                                Plan and visualize your content strategy.
                            </Item>
                            <Item title="Флаш карт" href="/features/hashtag-manager" icon={<HashIcon className="w-5 h-5" />}>
                                Research and track trending hashtags.
                            </Item>
                            <Item title="Шалгалтууд" href="/features/competitor-analysis" icon={<UsersIcon className="w-5 h-5" />}>
                ...
                <NavigationMenuItem>
                    ...
                    <NavigationMenuContent>
                        <ul className="grid w-[400px] gap-3 p-4 md:w-[400px] md:grid-cols-2 lg:w-[500px] xl:w-[500px]">
                            <Item title="SAT" href="/resources/blog" icon={<Newspaper className="w-5 h-5" />}>
                                Read our latest articles and updates.
                            </Item>
                            <Item title="IELTS" href="/resources/support" icon={<CircleHelp className="w-5 h-5" />}>
